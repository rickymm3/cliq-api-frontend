...
const createEvent$2 = function (eventName) {
  let {
    bubbles,
    cancelable,
    attributes
...
const triggerEvent$1 = function (eventName) {
  ...
  const event = createEvent$2(eventName, {
    bubbles,
    cancelable,
    attributes
  });
...
class DocumentView extends ObjectView {
  ...
  sync() {
    ...
    const event = createEvent$2("trix-before-render", {
      cancelable: false,
      attributes: {
        render
      }
...
class Document$1 extends TrixObject {
...
class HTMLParser extends BasicObject {
  ...
  getDocument() {
    return Document$1.fromJSON(this.blocks);
  }
...
const serializers = {
  "application/json": function (serializable) {
    let document;
    if (serializable instanceof Document$1) {
...
const deserializers = {
  "application/json": function (string) {
    return Document$1.fromJSONString(string);
  },
...
class Composition extends BasicObject {
  ...
  loadSnapshot(_ref) {
    ...
    this.setDocument(document != null ? document : new Document$1());
  ...
  insertBlock() {
    ...
    const document = new Document$1([block]);
    return this.insertDocument(document);
  }
  insertDocument() {
    let document = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Document$1();
    const selectedRange = this.getSelectedRange();
  ...
  insertLineBreak() {
    ...
    if (insertion.shouldDecreaseListLevel()) {
      ...
      const document = new Document$1([insertion.block.copyWithoutText()]);
      return this.insertDocument(document);
  ...
  breakFormattedBlock(insertion) {
    ...
    const newDocument = new Document$1([block.removeLastAttribute().copyWithoutText()]);
...
class Editor {
  ...
  loadJSON(_ref) {
    ...
    document = Document$1.fromJSON(document);
    return this.loadSnapshot({
      document,
      selectedRange
    });
...
_defineProperty(Level0InputController, "events", {
  ...
  drop(event) {
    ...
    if (files !== null && files !== void 0 && files.length) {
      ...
      const document = Document$1.fromJSONString(documentJSON);
...
const fixtures = {
  ...
  "partially formatted link": {
    document: new Document$1([new Block(new Text([new StringPiece("ab", {
      href: "http://example.com"
    }), new StringPiece("c", {
      href: "http://example.com",
      italic: true
  ...
  "spaces and formatting": {
    document: new Document$1([new Block(new Text([new StringPiece(" a "), new StringPiece("b", {
      href: "http://b.com"
  ...
  "image attachment": (() => {
    ...
    return {
      ...
      document: new Document$1([new Block(text)])
    };
  })(),
...
testGroup("Document", () => {
  const createDocumentWithAttachment = function (attachment) {
    const text = Text.textForAttachmentWithAttributes(attachment);
    return new Document$1([new Block(text)]);
  };
  ...
  test$3("getStringAtRange does not leak trailing block breaks", () => {
    const document = Document$1.fromString("Hey");
...
testGroup("HTMLParser", () => {
  ...
  test$3("forbids javascript: protocol in attachment href", () => {
  ...
  test$3("forbids data:text/html protocol in attachment href", () => {
...
const setDocument = json => {
  document$1 = Document$1.fromJSON(json);
...
testGroup("Accessibility attributes", {
  ...
  test$3("reads img[alt] from Attachment attributes", async () => {
    const element = getEditorElement();
    element.addEventListener("trix-attachment-add", event => event.attachment.setAttributes({
      alt: "some alt text"
    }));
...
testGroup("Attachments", {
  ...
  testGroup("File insertion", {
    ...
    test$3("setting previewURL makes an Attachment previewable", async () => {
      getEditorElement().addEventListener("trix-attachment-add", async _ref => {
        let {
          attachment
        } = _ref;
...
testGroup("Block formatting", {
  ...
  test$3("breaking out of a formatted block with adjacent non-formatted blocks", async () => {
    ...
    // b*
    // c
    let document = new Document$1([new Block(Text.textForStringWithAttributes("a"), []), new Block(Text.textForStringWithAttributes("b"), ["quote"]), new Block(Text.textForStringWithAttributes("c"), [])]);
    replaceDocument(document);
  ...
  test$3("breaking out of middle of heading block with preceding blocks", async () => {
    let document = new Document$1([new Block(Text.textForStringWithAttributes("a"), ["heading1"]), new Block(Text.textForStringWithAttributes("b"), []), new Block(Text.textForStringWithAttributes("cd"), ["heading1"])]);
    replaceDocument(document);
  ...
  test$3("inserting newline before heading", async () => {
    let document = new Document$1([new Block(Text.textForStringWithAttributes("\n"), []), new Block(Text.textForStringWithAttributes("abc"), ["heading1"])]);
    replaceDocument(document);
  ...
  test$3("inserting newline after heading with text in following block", async () => {
    let document = new Document$1([new Block(Text.textForStringWithAttributes("ab"), ["heading1"]), new Block(Text.textForStringWithAttributes("cd"), [])]);
    replaceDocument(document);
    getEditor().setSelectedRange(2);
    await typeCharacters("\n");
    document = getDocument();
  ...
  test$3("backspacing a newline in an empty block with adjacent formatted blocks", async () => {
    let document = new Document$1([new Block(Text.textForStringWithAttributes("abc"), ["heading1"]), new Block(), new Block(Text.textForStringWithAttributes("d"), ["heading1"])]);
    replaceDocument(document);
  ...
  test$3("backspacing a newline at beginning of non-formatted block", async () => {
    let document = new Document$1([new Block(Text.textForStringWithAttributes("ab"), ["heading1"]), new Block(Text.textForStringWithAttributes("\ncd"), [])]);
    replaceDocument(document);
    getEditor().setSelectedRange(3);
    await pressKey("backspace");
    document = getDocument();
  ...
  test$3("terminal attributes are only added once", async () => {
    replaceDocument(new Document$1([new Block(Text.textForStringWithAttributes("a"), []), new Block(Text.textForStringWithAttributes("b"), ["heading1"]), new Block(Text.textForStringWithAttributes("c"), [])]));
    await selectAll();
    await clickToolbarButton({
      attribute: "heading1"
    });
...
const configureInputAssociated = _ref => {
  let {
    target
  } = _ref;
  return target.willCreateInput = false;
};
...
testGroup("Installation process with specified elements", {
  ...
  test$3("trix-toolbar can reference editorElements and editorElement", () => {
    const editorElement = getEditorElement();
...
testGroup("Installation process with content and without specified elements", () => {
  test$3("loads the trix-editor element's innerHTML on boot", async () => {
  ...
  test$3("sanitizes the trix-editor element's innerHTML on boot", async () => {
...
testGroup("Installation process with content and input", () => {
  test$3("prioritzes loading its initial state from the input over the content", async () => {
...
var Idiomorph = function () {
  ...
  function morphOuterHTML(ctx, oldNode, newNode) {
    ...
    morphChildren(ctx, oldParent, newNode,
  ...
  function saveAndRestoreFocus(ctx, fn) {
    ...
    const results = fn();
    if (activeElementId && activeElementId !== ((_document$activeEleme = document.activeElement) === null || _document$activeEleme === void 0 ? void 0 : _document$activeEleme.id)) {
      var _activeElement;
      activeElement = ctx.target.querySelector("[id=\"".concat(activeElementId, "\"]"));
      (_activeElement = activeElement) === null || _activeElement === void 0 || _activeElement.focus();
    }
  ...
  const morphChildren = function () {
     ...
     */
    function morphChildren(ctx, oldParent, newParent) {
      let insertionPoint = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
      let endPoint = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
      // normalize
    ...
    const findBestMatch = function () {
      ...
      function isSoftMatch(oldNode, newNode) {
        ...
        return oldElt.nodeType === newElt.nodeType && oldElt.tagName === newElt.tagName && (
    ...
    function moveBeforeById(parentNode, id, after, ctx) {
      const target = /** @type {Element} - will always be found */

      ctx.target.id === id && ctx.target || ctx.target.querySelector("[id=\"".concat(id, "\"]")) || ctx.pantry.querySelector("[id=\"".concat(id, "\"]"));
  ...
  const createMorphContext = function () {
    ...
    function createMorphContext(oldNode, newContent, config) {
      ...
      if (!["innerHTML", "outerHTML"].includes(morphStyle)) {
        throw "Do not understand how to morph style ".concat(morphStyle);
      }
      return {
        target: oldNode,
...
function renderWithMorph(event) {
  event.render = (editorElement, documentFragment) => {
    Idiomorph.morph(editorElement, documentFragment, {
...
testGroup("morphing editor content", {
  ...
  test$3("renders changed elements with morphing", () => {
    const element = getEditorElement();
    element.editor.loadHTML("<div>hello</div>");
  ...
  test$3("renders with morphing when ancestor elements are morphed", () => {
    const element = getEditorElement();
    Idiomorph.morph(element.parentElement, "<trix-editor><div>hello</div></trix-editor>", {
      morphStyle: "innerHTML"
    });
    const before = element.firstElementChild;
    assert.equal(before.textContent, "hello");
    Idiomorph.morph(element.parentElement, "<trix-editor><div>goodbye</div></trix-editor>", {
      morphStyle: "innerHTML"
    });
    const after = element.firstElementChild;
    assert.equal(after.textContent, "goodbye");
