...
document.addEventListener("click", (e2) => {
  document.querySelectorAll(".cliq-dropdown").forEach((drop) => {
    if (!drop.contains(e2.target)) {
      drop.querySelector(".cliq-dropdown__options").classList.remove("open");
    }
  });
});
...
// app/javascript/controllers/cliq_controller.js
var cliq_controller_default = class extends Controller {
...
// app/javascript/controllers/sidebar_layout_controller.js
var sidebar_layout_controller_default = class extends Controller {
  static targets = [
    "leftSide",
    "rightSide",
    "leftToggle",
  ...
  updateOverlayState() {
    ...
    const active = this.leftSideTarget.classList.contains("is-overlay") && !this.leftSideTarget.classList.contains("is-collapsed");
...
application.register("cliq", cliq_controller_default);
application.register("form", form_controller_default);
application.register("search", search_controller_default);
application.register("sidebar-layout", sidebar_layout_controller_default);
